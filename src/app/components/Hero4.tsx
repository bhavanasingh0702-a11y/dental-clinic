...
return (
    ...
    >
        ...
        <div className="mt-12">
            <button type="button" className="inline-flex items-center gap-5 bg-sky-400 hover:bg-sky-500 transition-all text-white font-semibold text-xl px-10 py-4 rounded-full">
            {slides[current].button}

            <span className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-sky-500 text-xl">
                ↗
            </span>
            </button>
        </div>
