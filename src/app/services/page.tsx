        ...
        <p className="text-[#2A8CCB] uppercase tracking-[6px] font-semibold mb-4">
            ✦ Our Services
                    ...
                    <h2 className="text-5xl md:text-6xl font-bold">
                        <span className="text-[#2A8CCB]">High Quality</span>{" "}
...
{service.icon}
            ...
            <h3 className="text-2xl font-semibold mb-4 text-[#0E384C]">
{service.title}
</h3>
...
We believe in using the latest technology and techniques to <br />
    ...
    <div className="flex justify-center mt-12">
        ...
        <button
            ...
            className="bg-sky-600 text-white px-4 py-2 rounded-full hover:bg-[#0E384c] flex items-center gap-2 ">
            View All Service 
